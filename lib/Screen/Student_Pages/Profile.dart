                                        ...
                                        children: [
                                          Icon(profile[index]["icon"],color:  MyColors.Intro_button_Color,),Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(profile[index]["email"],style: TextStyle(fontSize: 20,color: MyColors.Intro_button_Color,fontWeight: FontWeight.bold,),),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 20,),
                                                      Text("Subject",style: TextStyle(color:  MyColors.Intro_button_Color,fontSize: 18,fontWeight: FontWeight.bold),),
                                                      TextField(
                                                          controller:Subject ,
                                                          decoration: InputDecoration(
                                                            focusedBorder: OutlineInputBorder(
                                                      ...
                                                      SizedBox(height: 20,),
                                                      Text("School/University ",style: TextStyle(color:  MyColors.Intro_button_Color,fontSize: 18,fontWeight: FontWeight.bold),),
                                                      TextField(
                                                          controller:School ,
                                                          decoration: InputDecoration(
                                                            focusedBorder: OutlineInputBorder(
